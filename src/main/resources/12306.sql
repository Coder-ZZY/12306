...
insert into tickets values(4,'T146','北京西','郑州','03:06','11:18','08:12','当日到达','--','--','--','--','19','--','有','--','有','无','--');
insert into tickets values(5,'Z6','北京西','郑州','03:52','09:53','06:01','当日到达','--','--','--','--','有','--','有','--','--','--','--');
insert into tickets values(6,'Z50','北京西','郑州','03:58','10:05','06:07','当日到达','--','--','--','--','有','--','有','--','有','无','--');
...
insert into tickets values(12,'G1572','北京西','郑州东','07:56','11:13','03:17','当日到达','候补','2','有','--','--','--','--','--','--','--','--');
insert into tickets values(13,'G1556','北京西','郑州东','08:52','12:18','03:26','当日到达','2','7','有','--','--','--','--','--','--','--','--');
insert into tickets values(14,'G572','北京西','郑州航空港','09:03','12:59','03:56','当日到达','候补','14','有','--','--','--','--','--','--','--','--');
...
insert into tickets values(17,'G68','北京西','郑州东','10:12','12:24','02:12','当日到达','17','有','有','--','--','--','--','--','--','--','--');
insert into tickets values(18,'G502','北京西','郑州东','10:47','14:12','03:25','当日到达','1','1','候补','--','--','--','--','--','--','--','--');
insert into tickets values(19,'G892','北京西','郑州东','10:57','13:25','02:28','当日到达','6','有','有','--','--','--','--','--','--','--','--');
insert into tickets values(20,'Z286','北京西','郑州','11:05','17:03','05:58','当日到达','--','--','--','--','有','--','有','--','有','有','--');
insert into tickets values(21,'G84','北京西',''郑州东',11:07','13:35','02:28','当日到达','14','候补','9','--','--','--','--','--','--','--','--');
...
insert into tickets values(35,'G58','北京西','郑州东','16:17','18:37','02:20','当日到达','候补','候补','有','--','--','--','--','--','--','--','--');
